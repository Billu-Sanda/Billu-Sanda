document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("mousemove", (e) => {
    ...
    trail.className = "trail-petal"; // <--- use trail-petal instead of petal
    ...
    setTimeout(() => trail.remove(), 1000); // <--- faster removal (1s instead of 2s)
  });
  ...
  noBtn.addEventListener("mouseover", () => {
    ...
    // Boundaries inside the proposal section
    const maxX = proposalRect.width - btnWidth - 20;
    const maxY = proposalRect.height - btnHeight - 20;
